...
public class SEe5a extends BaseSEe5a implements ProcessDownloadInterface {
	...
	@Override
	public SEe5a doInsert(LikDBAdapter adapter) {
		getdb(adapter);
	...
	@Override
	public SEe5a doUpdate(LikDBAdapter adapter) {
	...
	@Override
	public SEe5a doDelete(LikDBAdapter adapter) {
		SQLiteDatabase db = getdb(adapter);
	...
	@Override
	public SEe5a findByKey(LikDBAdapter adapter) {
		SQLiteDatabase db = getdb(adapter);
	...
	@Override
	public SEe5a queryBySerialID(LikDBAdapter adapter) {
		SQLiteDatabase db = getdb(adapter);
		// Constructs a new query builder and sets its table name
		SQLiteQueryBuilder qb = new SQLiteQueryBuilder();
		qb.setTables(getTableName());
	...
	public List<SEe5a> queryAllSEe5(LikDBAdapter adapter) {
		List<SEe5a> result = new ArrayList<SEe5a>();
		SQLiteDatabase db = getdb(adapter);
		// Constructs a new query builder and sets its table name
		SQLiteQueryBuilder qb = new SQLiteQueryBuilder();
		qb.setTables(getTableName());
